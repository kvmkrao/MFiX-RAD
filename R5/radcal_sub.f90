...
! Variable defintions specific to RADCAL
...
INTEGER, PARAMETER :: N_RADCAL_SPECIES = 16      !< Number of RadCal species (including soot) plus nitrogen and oxygen
 ...
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: PARTIAL_PRESSURES_ATM !< Partial pressure of species in each segment (atm)
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)   :: TEMP_GAS              !< Gas temperature of each segment (K)
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)   :: SEGMENT_LENGTH_M      !< Length of each sgment (m)
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)   :: TOTAL_PRESSURE_ATM    !< Total pressure of each segment (atm)

 DOUBLE PRECISION :: OMMIN      !< Minimum wave number in spectrum (1/cm)
 DOUBLE PRECISION :: OMMAX      !< Maximum wave number in spectrum (1/cm)
 DOUBLE PRECISION :: LAMBDAMIN  !< Minimum wavelength (microns)
 DOUBLE PRECISION :: LAMBDAMAX  !< Maximum wavelength (microns)
 DOUBLE PRECISION :: TWALL      !< Wall temperature (K)
 DOUBLE PRECISION :: TAU
 DOUBLE PRECISION :: XTOT
 DOUBLE PRECISION :: FV         !< Soot volume fraction

INTEGER:: NPT

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: GAMMA
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: SD15
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: SD
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: SD7
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: SD3
...
INTEGER, PARAMETER :: I_MODEL_CH4=3    !< Flag for Elsasser model
 ...
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C3H6_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C3H8_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C7H16_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C7H8_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_CH3OH_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C5H8O2_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C2H6_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_CH4_TEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: SD_C2H4_TEMP

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C3H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C7H16
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)    :: BE_C2H4

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_CH4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C3H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C7H16
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: OM_BND_C2H4

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_CH4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_CH4

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_C3H6

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C3H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C3H8

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C7H16
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C7H16

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD4_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD5_C7H8

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD4_CH3OH

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD4_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD5_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD6_C5H8O2

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_C2H6

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD1_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD2_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD3_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: SD4_C2H4

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C3H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_C3H6

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C3H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C3H8

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C7H16
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C7H16

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD4_C7H8
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD5_C7H8

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_CH3OH
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD4_CH3OH

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD4_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD5_C5H8O2
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD6_C5H8O2

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C2H6
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_C2H6

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD1_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD2_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD3_C2H4
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:)  :: GAMMAD4_C2H4

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)  :: AB, WAVE_NUMBER, LAMBDA
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:)  :: INCIDENT_RADIANCE

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:) :: TTAU

INTEGER :: NOM  !< Number of wavelength intervals

 DOUBLE PRECISION, PARAMETER :: M_TO_CM = 100.0_EB  !< Conversion factor, m to cm
 DOUBLE PRECISION, PARAMETER :: CM_TO_M = 0.01_EB   !< Conversion factor, cm to m

 DOUBLE PRECISION :: PFUEL
...
SUBROUTINE INIT_RADCAL 
 ...
 DOUBLE PRECISION :: OMEGA !< Wavenumber (1/cm)
 DOUBLE PRECISION :: DOM   !< Delta wavenummber (1/cm)
...
if (.not. allocated(INCIDENT_RADIANCE)) ALLOCATE(INCIDENT_RADIANCE(NOM)) 
INCIDENT_RADIANCE   = 0.0_EB
if (.not. allocated(TTAU)) ALLOCATE(TTAU(0:NPT,NOM))  
TTAU                = 1.0_EB

if (.not. allocated(LAMBDA)) ALLOCATE(LAMBDA(NOM))    
LAMBDA      = 0.0_EB
if (.not. allocated(AB)) ALLOCATE(AB(NOM))          
AB          = 0.0_EB
if (.not. allocated(WAVE_NUMBER)) ALLOCATE(WAVE_NUMBER(NOM)) 
WAVE_NUMBER = 0.0_EB
...
!------------------------------------------------------------------------------
 ...
 DOUBLE PRECISION, INTENT(OUT) :: EFFECTIVE_ABSORPTION,PLANCK_MEAN_ABSORPTION,RADIANCE,TOTAL_TRANSMISSIVITY

 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: PATH_LENGTH_CM !< Segment path lengths (cm)
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: AZOTEMP        !< Ratio of reference temperature (273 K) to segment temperature
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: TAUS
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: TAUL
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: X_PARTICLE     !< Optical depth for particle in segment
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: AB_PLANCK
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: AB_TAU
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: BB_SPECT
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: BB_GAS
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:):: BB_WALL
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: CURTIS_XSTAR
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: CURTIS_ACOLLISION
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: CURTIS_ADOPPLER
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: GC
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: OPTICAL_THICKNESS !< Optical thickess of ith species in each segment (CMSTP)
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:,:):: OPTICAL_DEPTH
 DOUBLE PRECISION:: RSL
 DOUBLE PRECISION:: RSS
 DOUBLE PRECISION::OMEGA !> Wavenumber (1/cm)
 DOUBLE PRECISION::WAVE_LENGTH
 DOUBLE PRECISION::DAMBDA
 DOUBLE PRECISION::LTERM
 DOUBLE PRECISION::TEMP4 !> Local temperature to the fourth power (K4)
 DOUBLE PRECISION::AVG_TEMP
 DOUBLE PRECISION::TOTAL_LENGTH_CM
 DOUBLE PRECISION::INT_BB_GAS
 DOUBLE PRECISION::INT_BB_WALL
...
FUNCTION COLLISION_BROADENING(SPECIES_PRESSURE_ATM,PTOT,AZOTEMP) RESULT(GC)
 ...
 DOUBLE PRECISION, DIMENSION(:), INTENT(IN) :: SPECIES_PRESSURE_ATM
 DOUBLE PRECISION, INTENT(IN) :: PTOT
 DOUBLE PRECISION, INTENT(IN) :: AZOTEMP
 DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:) :: GC

 DOUBLE PRECISION :: P_FUEL
...
! VARIABLES PASSED IN
 DOUBLE PRECISION, DIMENSION(:), INTENT(IN) :: P_ATM, OPTICAL_THICKNESS, GC
 DOUBLE PRECISION, INTENT(IN) :: PTOT, TEMP, OMEGA, PATH_LENGTH_CM

! VARIABLES PASSED INOUT
 DOUBLE PRECISION, DIMENSION(:,:), INTENT(INOUT) :: CURTIS_XSTAR, CURTIS_ACOLLISION,   &
                                          CURTIS_ADOPPLER, OPTICAL_DEPTH

! LOCAL
 DOUBLE PRECISION :: X_DOPPLER, X_COLLISION, XSTAR
 DOUBLE PRECISION :: SDWEAK,    A_COLLISION, A_DOPPLER
...
! VARIABLES IN:
 DOUBLE PRECISION, INTENT(IN) :: XSTAR
 DOUBLE PRECISION, INTENT(IN) :: A_DOPPLER
INTEGER,  INTENT(IN) :: I_MODEL

! VARIABLE OUT
 DOUBLE PRECISION :: X_DOPPLER
...
! VARIABLES PASSED IN
 DOUBLE PRECISION, INTENT(IN) :: X_COLLISION
 DOUBLE PRECISION, INTENT(IN) :: X_DOPPLER
 DOUBLE PRECISION, INTENT(IN) :: XSTAR
...
! LOCAL VARIABLES
 DOUBLE PRECISION :: Y_DOPPLER, Y_COLLISION, Y_COMBINED
...
IMPLICIT NONE
 ...
 DOUBLE PRECISION, INTENT(IN) :: XSTAR
 DOUBLE PRECISION, INTENT(IN) :: A_COLLISION

 DOUBLE PRECISION  :: X_GOODY
...
! VARIABLES PASSED OUT
 DOUBLE PRECISION  :: X_ELSASSER

! LOCAL VARIABLES

 DOUBLE PRECISION :: X_COLLISION
...
! VARIABLE PASSED IN
 DOUBLE PRECISION, DIMENSION(:), INTENT(IN) :: TRANSITION_WN ! WAVENUMBER ASSOCIATED WITH
                                                   ! A VIBRATION MODE

 DOUBLE PRECISION, DIMENSION(:), INTENT(IN) :: DEGENERACY  ! DENEGERACY OF ENERGY LEVEL
                                                ! ASSOCIATED WITH A VIBRATION
                                                ! MODE

 DOUBLE PRECISION, INTENT(IN) :: TEMP                     ! TEMPERATURE IN KELVIN

! VARIABLE PASSED OUT
 DOUBLE PRECISION :: PARTITION_FUNCTION

! LOCAL VARIABLES
 DOUBLE PRECISION, PARAMETER :: Q2 = 1.4388_EB   ! SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION :: Q2_OVER_T
INTEGER  :: N_MODE
INTEGER  :: I_MODE
...
! VARIABLE PASSED IN
 DOUBLE PRECISION, DIMENSION(3,3), INTENT(IN) :: TRANSITION_MATRIX ! SQUARE MATRIX
 DOUBLE PRECISION, DIMENSION(:),   INTENT(IN) :: BCNT ! BAND CENTER IN WAVENUMBERS (CM-1)
 DOUBLE PRECISION, DIMENSION(:),   INTENT(IN) :: OM
 DOUBLE PRECISION, DIMENSION(:),   INTENT(IN) :: LINE_STRENGTH

 DOUBLE PRECISION, INTENT(IN) :: OMEGA ! WAVENUMBER OF SOUGHT PROPERTIES
 DOUBLE PRECISION, INTENT(IN) :: BE    ! ROTATIONAL CONSTANT
 DOUBLE PRECISION, INTENT(IN) :: TEMP  ! TEMPERATURE IN KELVIN
 DOUBLE PRECISION, INTENT(IN) :: GC1
 DOUBLE PRECISION, INTENT(IN) :: GD
 DOUBLE PRECISION, INTENT(IN), OPTIONAL :: LINE_SPACING ! OPTIONAL

! VARIABLES PASSED OUT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK
 DOUBLE PRECISION, INTENT(OUT) :: GDINV
 DOUBLE PRECISION, INTENT(OUT) :: GDDINV

! LOCAL VARIABLES
 DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: TRANSITION_WN, ATOT
 DOUBLE PRECISION, PARAMETER :: Q2 = 1.4388_EB   ! SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: T0 = 300._EB     ! REFERENCE TEMPERATURE, IN KELVIN

 DOUBLE PRECISION :: T0OT
 DOUBLE PRECISION :: Q2OT
...
! VARIABLES PASSED IN
 DOUBLE PRECISION, INTENT(IN) :: OMEGA ! WAVENUMBER, UNITS IN CM-1
 DOUBLE PRECISION, INTENT(IN) :: TEMP  ! TEMPERATURE, UNITS IN KELVIN
 DOUBLE PRECISION, INTENT(IN) :: GC1   ! HALF WIDTH AT HALF HEIGHT FOR LORENTZ LINE, UNITS IN CM-1

! VARIABLES PASSED OUT
 DOUBLE PRECISION, INTENT(OUT):: SDWEAK  ! NARROW BAND MEAN ABS(ORTION COEFFICIENT, UNITS IN CM-1
 DOUBLE PRECISION, INTENT(OUT):: GDINV   ! LINE WIDTH TO LINE SPACING RATION FOR LORENTZ LINES
 DOUBLE PRECISION, INTENT(OUT):: GDDINV  ! LINE WIDTH TO LINE SPACING RATION FOR DOPPLER
INTEGER,  INTENT(OUT):: I_MODEL ! MODEL USED FOR SNB FITTING: 1: GOODY, 2 MALKMUS, 3 ELSASSER

! LOCAL VARIABLES
INTEGER  :: I,J,K,L

 DOUBLE PRECISION, PARAMETER :: WM_CO2 = 44._EB      ! MOLAR MASS (IN GRAM) OF CO2
 DOUBLE PRECISION, PARAMETER :: BE     = 0.391635_EB ! ROTATIONAL CONSTANT CO2
 DOUBLE PRECISION, PARAMETER :: Q2     = 1.4388_EB   ! SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: T0     = 300._EB     ! REFERENCE TEMPERATURE, IN KELVIN

 DOUBLE PRECISION, PARAMETER :: OM1 = 1354.91_EB  ! FUNDAMENTAL FREQUENCY FOR TRANSITION (000)->(100), UNITS CM-1
 DOUBLE PRECISION, PARAMETER :: OM2 =  673.0_EB   ! FUNDAMENTAL FREQUENCY FOR TRANSITION (000)->(010), UNITS CM-1
 DOUBLE PRECISION, PARAMETER :: OM3 = 2396.49_EB  ! FUNDAMENTAL FREQUENCY FOR TRANSITION (000)->(001), UNITS CM-1

 DOUBLE PRECISION, DIMENSION(3) :: ATOT, BCNT
 DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE  :: OM, LINE_STRENGTH
 DOUBLE PRECISION, DIMENSION(3,3) :: TRANSITION_MATRIX

 DOUBLE PRECISION :: AA,BB,CC,QQ,EE,FF,GG, &
...
! VARIABLES PASSED IN
 ...
 DOUBLE PRECISION, INTENT(IN) :: OMEGA ! WAVENUMBER,  IN CM-1
 DOUBLE PRECISION, INTENT(IN) :: TEMP  ! TEMPERATURE, IN KELVIN
 DOUBLE PRECISION, INTENT(IN) :: GC2   ! HALF WIDTH AT HALF HEIGHT, IN CM-1

! VARIABLES PASSED OUT

 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK  ! SPECTRAL ABSORPTION COEFFICIENT, IN CM-1
 DOUBLE PRECISION, INTENT(OUT) :: GDDINV  ! LINE WIDTH TO LINE SPACING RATION FOR DOPPLER
 DOUBLE PRECISION, INTENT(OUT) :: GDINV   ! LINE WIDTH TO LINE SPACING RATIO FOR LORENTZ BORADENING
INTEGER,  INTENT(OUT) :: I_MODEL ! MODEL USED FOR SNB FITTING: 1: GOODY, 2 MALKMUS, 3 ELSASSER

! LOCAL VARIABLES

INTEGER  :: I,J
 DOUBLE PRECISION :: W1, WW, T1, TT, TW, D, B, DINV, TTEMP, GD
 DOUBLE PRECISION, PARAMETER :: WM_H2O = 18._EB
...
! I_MODEL: (INTEGER) MODEL USED FOR SNB FITTING: 1: GOODY, 2 MALKMUS, 3 ELSASSER
INTEGER J
 DOUBLE PRECISION OMEGA,TEMP,GC4,SDWEAK,GDINV,GDDINV,AA,BB,CC,QQ,EE,FF,GG, &
...
! VARIABLES PASSED IN:
 ...
 DOUBLE PRECISION, INTENT(IN) :: OMEGA, PATH_LENGTH_CM, SOOT_VOLUME_FRAC, TEMP

! VARIBLES PASSED OUT: X_PARTICLE: PARTICLE OPTICAL DEPTH

 DOUBLE PRECISION, INTENT(OUT) :: X_PARTICLE

! LOCALS

 DOUBLE PRECISION :: ABCO,FF,LAMBDA,RIN,RIK
...
! I_MODEL: (INTEGER) MODEL USED FOR SNB FITTING: 1: GOODY, 2 MALKMUS, 3 ELSASSER
INTEGER I,J
 DOUBLE PRECISION OMEGA,TEMP,PCH4,PTOT,GC3,SDWEAK,GDINV,GDDINV,BE,Q2, &
   WM,GD,OM1,OM2,OM3,OM4,COM1,COM2,COM3,COM4,DINV,PE,W1,SDB, &
   SDA,SDC,Q2OT,AZOT,TOAZ

INTEGER, INTENT(OUT) :: I_MODEL

 DOUBLE PRECISION, DIMENSION(4) :: ATOT, BCNT
...
! DINV_CH4           : INVERSE LINE SPACING [CM]
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PCH4, PTOT, GC3
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV

INTEGER, INTENT(OUT)  :: I_MODEL

 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE, Q2OT, AZOT, TOAZ, FACT1

 DOUBLE PRECISION, PARAMETER :: Q2     = 1.4388_EB ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_CH4 = 16.0425_EB

!LINE SPACING D2_CH4=5.74 CM^-1 FOR THE V4 FUNDAMENTAL OF METHANE GRAY & PENNER,612
!FOOTNOTE AT BOTTOM
 DOUBLE PRECISION, PARAMETER :: BE_CH4 = 5.248_EB   ! ROTATIONAL CONSTANTS [CM^-1]
 DOUBLE PRECISION, DIMENSION(3), PARAMETER :: DINV_CH4 = (/1._EB/5.1_EB,1._EB/9.4_EB,1._EB/5.74_EB/)
 ...
 DOUBLE PRECISION, DIMENSION(4) :: ATOT
...
! DINV_C3H6         : INVERSE LINE SPACING [CM] FOR PROPYLENE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC3H6, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV

INTEGER, INTENT(OUT) :: I_MODEL

 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C3H6

 DOUBLE PRECISION, PARAMETER :: Q2       = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C3H6  = 42.0797_EB ! NIST WEBBOOK DATA
...
! DINV_C3H8         : INVERSE LINE SPACING [CM] FOR PROPANE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC3H8, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C3H8

 DOUBLE PRECISION, PARAMETER :: Q2       = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C3H8  = 44.0956_EB ! NIST WEBBOOK DATA
...
! DINV_C7H16         : INVERSE LINE SPACING [CM] FOR HEPTANE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC7H16, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C7H16

 DOUBLE PRECISION, PARAMETER :: Q2       = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C7H16 = 100.2019_EB ! NIST WEBBOOK DATA
...
! DINV_C7H8         : INVERSE LINE SPACING [CM] FOR TOLUENE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC7H8, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C7H8

 DOUBLE PRECISION, PARAMETER :: Q2       = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C7H8  = 92.1384_EB ! NIST WEBBOOK DATA
...
! DINV_CH3OH         : INVERSE LINE SPACING [CM] FOR METHANOL
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PCH3OH, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_CH3OH

 DOUBLE PRECISION, PARAMETER :: Q2       = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_CH3OH = 32.0419_EB ! NIST WEBBOOK DATA
INTEGER :: I_BAND, I
...
! DINV_C5H8O2         : INVERSE LINE SPACING [CM] FOR MMA
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC5H8O2, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C5H8O2

 DOUBLE PRECISION, PARAMETER :: Q2        = 1.4388_EB   ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C5H8O2 = 100.1158_EB ! NIST WEBBOOK DATA
INTEGER :: I_BAND, I
...
! DINV_C2H6         : INVERSE LINE SPACING [CM] FOR ETHANE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC2H6, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C2H6

 DOUBLE PRECISION, PARAMETER :: Q2      = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C2H6 = 30.0690_EB ! NIST WEBBOOK DATA
INTEGER :: I_BAND, I
...
! DINV_C2H4          : INVERSE LINE SPACING [CM] FOR ETHYLENE
 ...
 DOUBLE PRECISION, INTENT(IN)  :: OMEGA, TEMP, PC2H4, PTOT
 DOUBLE PRECISION, INTENT(OUT) :: SDWEAK, GDINV, GDDINV
...
INTEGER, INTENT(OUT) :: I_MODEL
 ...
 DOUBLE PRECISION :: Q2OT, AZOT, TOAZ
 DOUBLE PRECISION :: GD, PRESSURE_EFFECTIVE
 DOUBLE PRECISION :: DINV_C2H4

 DOUBLE PRECISION, PARAMETER :: Q2      = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
 DOUBLE PRECISION, PARAMETER :: WM_C2H4 = 28.0532_EB ! NIST WEBBOOK DATA
INTEGER :: I_BAND, I
...
!==============================================================================
PURE  DOUBLE PRECISION FUNCTION GET_SPECTRAL_ABSORPTION(OMEGA,TEMP,SD_TEMP,BOUNDS,ABSORPTION_DATA)
!==============================================================================
...
! VARIABLES PASSED IN
 ...
 DOUBLE PRECISION, DIMENSION(:), INTENT(IN)   :: SD_TEMP, BOUNDS
 DOUBLE PRECISION, DIMENSION(:,:), INTENT(IN) :: ABSORPTION_DATA

 DOUBLE PRECISION :: DELTA_T
 DOUBLE PRECISION :: DELTA_W
 DOUBLE PRECISION :: W1
 DOUBLE PRECISION :: OMEGA_MIN, OMEGA_MAX, DELTA_OMEGA
...
ELEMENTAL  DOUBLE PRECISION FUNCTION PLANCK(TEMP,LAMBDA)
...
ELEMENTAL  DOUBLE PRECISION FUNCTION PLANCK_WN(TEMP,OMEGA)
...
!> \param X array of x
 ...
 DOUBLE PRECISION FUNCTION INTEGRATION(X,Y)

 DOUBLE PRECISION, INTENT(IN), DIMENSION(:) :: X,Y

 DOUBLE PRECISION :: ALPHA, BETA, GAMMA, B, A, SEGMENT_INT
