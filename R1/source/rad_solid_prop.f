...
integer, parameter :: biomass=205, moisture= 801
...
! given species id in dababase and wavenumber, return complex refractive index at this wavenumber
    ...
    select case (sid)
        ...
        !case (204) ! lime
        case (205) !  biomass Atmos Chem Phys (2011) doi:10.5194/acp-11-1491-2011
           m = cmplx(1.6d0, -0.06d0, dp)
        case (801) 
        !    m = cmplx(2.15d0, -0.0398d0, dp) !Q. Fu, in Encyclopedia of Atmospheric Sciences (Second Edition), 2015
           m = cmplx(2.13d0, -0.504d0, dp) !Optical constants of H2O, D2O (Water, heavy water, ice) Hale and Querry 1973: Water; n,k 0.2-200 µm; 25 °C
...
function genNBInterval() result(nbInt)
    ...
    ! first/second column is the start/end of narrow band
